    ...
    <PromisesContainer>
      ...
      <PromiseBox>
        <Text font="sansSerif">
          ...
          vast majority of the world's countries—including all of the great
      ...
      <PromiseBox>
        <Text font="sansSerif">
          ...
          Hitler's suicide and the German unconditional surrender on 8 May 1945.
          ...
          bombings, and the Soviet’s declared entry into the war against Japan
          on the eve of invading Manchuria, Japan announced on 15 August its
