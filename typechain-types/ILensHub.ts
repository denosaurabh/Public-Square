...
export type SetDefaultProfileWithSigDataStructOutput = [
  ...
  string,
  EIP712SignatureStructOutput
] & { profileId: BigNumber; wallet: string; sig: EIP712SignatureStructOutput };
...
export interface ILensHubInterface extends utils.Interface {
  functions: {
    ...
    "setDefaultProfile(uint256,address)": FunctionFragment;
    "setDefaultProfileWithSig((uint256,address,(uint8,bytes32,bytes32,uint256)))": FunctionFragment;
