...
export interface SecretCodeFollowModuleInterface extends utils.Interface {
  functions: {
...
export interface SecretCodeFollowModule extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: SecretCodeFollowModuleInterface;
